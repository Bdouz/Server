...
public class ObjectManager {
	...
	public void loadCustomSpawns(Client client) {
		...
		client.getPA().checkObjectSpawn(3515, 3090, 3488, 1, 10); // comp
		...
		client.getPA().checkObjectSpawn(409, 3092, 3506, 0, 10); // altar
		client.getPA().checkObjectSpawn(75, 3086, 3483, 0, 10); // altar
		client.getPA().checkObjectSpawn(-1, 3092, 3488, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3096, 3498, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3095, 3498, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3095, 3499, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3098, 3499, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3092, 3496, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3078, 3510, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3079, 3510, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3080, 3510, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3081, 3510, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3082, 3510, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3090, 3504, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 3090, 3503, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3411, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3411, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3412, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3412, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3413, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3413, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3414, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3414, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3415, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3415, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2602, 3416, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2601, 3416, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2603, 3417, 0, 10); //removed object
		client.getPA().checkObjectSpawn(-1, 2604, 3417, 0, 10); //removed object
		client.getPA().checkObjectSpawn(9739, 3098, 3499, 0, 10);
		/* New Donator Zone */
