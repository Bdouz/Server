...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 327:
			...
			break;
		case 328:
			itemOnDialogue3("Primordial Boots","Are you sure you wish to infuse the Dragon boots and","Primordial crystal to create Primordial boots??","This can not be reversed.", 13239, 250);
			c.nextChat = 329;
			c.dialogueAction = 328;
			break;
		case 329:
			sendOption2("Proceed with the infusion.",
					"Cancel.");
			c.nextChat = 330;
			c.dialogueAction = 328;
			break;
	...
	public void itemOnDialogue4(String header, String one, String two, String three, String four, int item, int zoom){
	...
	public void itemOnDialogue3(String header, String one, String two, String three, int item, int zoom){
	...
	public void itemOnDialogue2(String header, String one, String two, int item, int zoom){
