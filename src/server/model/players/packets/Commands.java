...
public class Commands implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		if (c.playerRights == 3 || c.playerName.equalsIgnoreCase("") || c.playerName.equalsIgnoreCase("") || c.playerName.equalsIgnoreCase("")) { // 3
	...
	public static void helperCommands(Client c, String playerCommand) {
		if (c.playerName.contains("") || c.playerName.contains("")
				|| c.playerName.contains("")
				|| c.playerName.contains("")
				|| c.playerName.contains("") || c.playerName.contains("") || c.playerName.contains("")) {
			donatorCommands(c, playerCommand);
	...
	public static void ownerCommands(final Client c, String playerCommand) {
		...
		if (playerCommand.startsWith("yell") && c.playerRights == 3) {
			...
			if (c.playerName.equalsIgnoreCase("") || (c.playerName.equalsIgnoreCase(""))) {
		...
		if (playerCommand.startsWith("reloadshops")) {
			...
			c.sendMessage("Shops have been reloaded.");
		}
	...
	public static void playerCommands(Client c, String playerCommand) {
		...
		if (playerCommand.startsWith("vote")) {
			c.getPA().sendNewString("www.agathaps.x10.bz/", 12000);
		}
		...
		if (playerCommand.equalsIgnoreCase("commands")) {
			c.sendMessage("::infernals ::resettask");
			c.sendMessage("::dicing ::duel");
			c.sendMessage("::empty ::skull ::players ::forums ::donate ::highscores");
		...
		if (playerCommand.startsWith("updates")) {
			c.getPA().sendNewString("www.agathaps.x10.bz/forumdisplay.php?fid=3", 12000);
		}
